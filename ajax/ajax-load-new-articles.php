<?php
  ...
  $id = mysqli_real_escape_string($link, $_POST['profile_id']);

  $sql = "SELECT * FROM articles WHERE article_uid = $id AND article_visible = 1 ORDER BY article_id DESC LIMIT $limit";
